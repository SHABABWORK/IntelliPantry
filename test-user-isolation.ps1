...
$itemA1 = @{ id = "prod_1"; name = "Milk"; category = "Dairy"; quantity = 1; unit = "L"; expiryDate = "2026-09-25"; status = "Expiring Soon"; emoji = "Milk" }
$itemA2 = @{ id = "prod_2"; name = "Rice"; category = "Grains"; quantity = 2; unit = "kg"; expiryDate = "2026-12-01"; status = "Fresh"; emoji = "Rice" }
...
$itemB1 = @{ id = "prod_3"; name = "Eggs"; category = "Dairy"; quantity = 12; unit = "pcs"; expiryDate = "2026-10-05"; status = "Fresh"; emoji = "Eggs" }
